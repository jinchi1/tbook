...
public class OtherFollowingListAdapter extends BaseAdapter {
    ...
    public  OtherFollowingListAdapter(Context context, ArrayList<FollowingListData> arr){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.followBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    callApi_Unfollow(data.follow_idx);
