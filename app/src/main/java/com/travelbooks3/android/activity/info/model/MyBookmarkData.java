...
public class MyBookmarkData {
    ...
    public static MyBookmarkData MyBookmarkListJson(MyBookmarkData data, JSONObject json) throws Exception{
        if(data == null) data = new MyBookmarkData();
        ...
        if (!json.isNull("bookmark_idx"))        data.bookmark_idx=json.getInt("bookmark_idx");
