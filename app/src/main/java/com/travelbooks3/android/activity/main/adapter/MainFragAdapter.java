...
import com.travelbooks3.android.activity.main.AtvTripMap;
...
import com.travelbooks3.android.util.ClickOnlyMovementMethod;
...
import static com.travelbooks3.android.R.id.bookmark_lay;
import static com.travelbooks3.android.R.id.jidoView;
import static com.travelbooks3.android.R.id.like_lay;
import static com.travelbooks3.android.R.id.map;

import static com.travelbooks3.android.R.id.visible;
import static com.travelbooks3.android.R.id.wrap_content;
import static com.travelbooks3.android.R.id.write_content_txt;
import static com.travelbooks3.android.activity.main.model.MainListData.duration;
import static com.travelbooks3.android.util.FormatUtil.FormatGetDate;
import static com.travelbooks3.android.util.FormatUtil.FormatStringGetDate;
import static com.travelbooks3.android.util.FormatUtil.calculateTime;
import static com.travelbooks3.android.util.FormatUtil.dipToPixels;
...
public class MainFragAdapter extends BaseAdapter{
    ...
    private ArrayList<MainListData> dataArr;
    private MainImgPagerAdapter _adapter;
    ListView listView;
    int a;
    int b;
    int cc;
    ...
    public MainFragAdapter(Context context, ArrayList<MainListData> arr, LinkedHashMap count, ListView _list) {
    ...
    public void setAddItem(ArrayList<MainListData> addItem) {
        dataArr = addItem;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        b=0;
        final MainListData data = dataArr.get(position);
        cc = position;
        ...
        for (int i = 0; i < hashtagSpans.size(); i++) {
            ...
            hashTag.setOnClickEventListener(new HashTag.ClickEventListener() {
                ...
                public void onClickEvent(String data) {
                    ...
                    LogUtil.d("aaaaaaaaaaaaaaaaaaa"+data);
        ...
        if (convertView == null) {
           ...
           /* viewHolder.baseMore = (TextView) convertView.findViewById(R.id.txtMore);*/
            ...
            viewHolder.bookmark_lay = (LinearLayout)convertView.findViewById(bookmark_lay);
...
*/
                ...
                intent.putParcelableArrayListExtra("PhotoArr",data.photoArr);
...
//            }
        ...
        viewHolder.nameTxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LogUtil.d("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"+data.name);

                if(SPUtil.getInstance().getUserNumber(context)!=data.user_idx) {
                    Bundle bundle = new Bundle();
                    bundle.putString("search_user_idx", String.valueOf(data.user_idx));
                ...
                else if(SPUtil.getInstance().getUserNumber(context)==data.user_idx)
                {
                    FragmentManager fragmentManager = ((AppCompatActivity) context).getSupportFragmentManager();
        ...
        viewHolder.writeName2.setText(data.name);
        ...
        if("Y".equals(data.isLike))
        {
            ...
            viewHolder.like_lay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    callApi_unclickLike(data.like_idx);
        ...
        if("Y".equals(data.isBookmark)) {
            ...
            viewHolder.bookmark_lay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    callApi_unclickbookmark(data.bookmark_idx);
        ...
        _adapter = new MainImgPagerAdapter(context, data.photoArr);
        viewHolder.sliderLayout.setAdapter(_adapter);

        if(count.get(position)!=null) viewHolder.sliderLayout.setCurrentItem(count.get(position));
        else viewHolder.sliderLayout.setCurrentItem(0);
        ...
        viewHolder.sliderLayout.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            @Override
            public void onPageSelected(final int num) {
                LogUtil.d("indicator count [" + position + "(" + num + ")]: " + viewHolder.sliderLayout.getChildCount());
...
*/
 ...
 /*       TextView name = new TextView(context);
        ...
        viewHolder.write_content_txt.setMovementMethod(ClickOnlyMovementMethod.getInstance());
        ...
        viewHolder.more_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putParcelableArrayListExtra("mainPhotoArr",data.photoArr);
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.more_lay:
                    final MainListData data = (MainListData) v.getTag();
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                switch (which) {
                                    ...
                                    case 2:
                                        ...
                                        bundle1.putString("command","main");
                                        fragmentManager =  ((AppCompatActivity) context).getSupportFragmentManager();
                                        android.support.v4.app.FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
...
*/
               ...
               /* case R.id.change_act:


                    MainListData mapData = (MainListData) v.getTag();
                    LogUtil.d(mapData.latitude+mapData.longitude);

                    Intent intent = new Intent();
                    intent.setClass(context, TripInfoActivity.class);
                    intent.putExtra("trip_uid", mapData.trip_uid);
                    intent.putParcelableArrayListExtra("PhotoArr",mapData.photoArr);
        ...
        client.addHandler(new GResultHandler() {
            ...
            public GBean result(GBean bean, Object result, int returnCode, String returnMessage, JSONObject responseData) {
                ...
                if (returnCode == GReturnCode.SUCCESS_POSTING_LIKE_REGISTER) {
                    ...
                    try {
                        if (!json2.isNull("idx")) dataArr.get(position).like_idx = json2.getString("idx");
                    }catch (Exception e){
        ...
        client.addHandler(new GResultHandler() {
            ...
            public GBean result(GBean bean, Object result, int returnCode, String returnMessage, JSONObject responseData) {
                ...
                if (returnCode == GReturnCode.SUCCESS_POSTING_BOOKMARK_REGISTER) {
                    ...
                    try {
                        if (!json2.isNull("idx")) dataArr.get(position).bookmark_idx = json2.getString("idx");
                        Log.i("aaaaa :",dataArr.get(position).bookmark_idx);
                    }catch (Exception e){
                        e.printStackTrace();
