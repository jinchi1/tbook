...
public class BookmarkFeedInfoAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<MyBookmarkData.Photos> dataArr;

    public  BookmarkFeedInfoAdapter(Context context, ArrayList<MyBookmarkData.Photos> arr){
        this.context = context;
        this.dataArr = arr;
    }

    public void addItems(ArrayList<MyBookmarkData.Photos> addItem) {
        dataArr = addItem;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final MyBookmarkData.Photos data = dataArr.get(position);
