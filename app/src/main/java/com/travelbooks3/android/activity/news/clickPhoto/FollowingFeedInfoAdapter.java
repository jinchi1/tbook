...
public class FollowingFeedInfoAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<FollowingPagerData.Post.Photos> dataArr;

    public  FollowingFeedInfoAdapter(Context context, ArrayList<FollowingPagerData.Post.Photos> arr){
        this.context = context;
        this.dataArr = arr;
    }

    public void addItems(ArrayList<FollowingPagerData.Post.Photos> addItem) {
        dataArr = addItem;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final FollowingPagerData.Post.Photos data = dataArr.get(position);
