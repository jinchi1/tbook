...
/**
 * Created by system777 on 2017-09-28.
 */

public class MainImgPhotoAdapter extends PagerAdapter {

    private Context context;
    private LayoutInflater inflater;
    private ArrayList<MainListData.Photos> imgUrlArr2;


    public MainImgPhotoAdapter(ClickPhotoActivity context, ArrayList<MainListData.Photos> imgUrlArr2){
        this.context = context;
        inflater = LayoutInflater.from(context);
        this.imgUrlArr2 = imgUrlArr2;
    }

    public MainImgPhotoAdapter(Context context, ArrayList<MainListData.Photos> imgUrlArr2){
        this.context = context;
        inflater = LayoutInflater.from(context);
        this.imgUrlArr2 = imgUrlArr2;
    }
