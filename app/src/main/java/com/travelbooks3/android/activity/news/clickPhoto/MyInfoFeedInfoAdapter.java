...
public class MyInfoFeedInfoAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<MyInfoData.Photos> dataArr;

    public  MyInfoFeedInfoAdapter(Context context, ArrayList<MyInfoData.Photos> arr){
        this.context = context;
        this.dataArr = arr;
    }

    public void addItems(ArrayList<MyInfoData.Photos> addItem) {
        dataArr = addItem;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final MyInfoData.Photos data = dataArr.get(position);
