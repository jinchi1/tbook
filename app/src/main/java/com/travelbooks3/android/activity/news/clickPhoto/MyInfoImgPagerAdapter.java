...
public class MyInfoImgPagerAdapter extends PagerAdapter{

    private Context context;
    private LayoutInflater inflater;
    private ArrayList<MyInfoData.Photos> imgUrlArr2;


    public MyInfoImgPagerAdapter(ClickPhotoActivity context, ArrayList<MyInfoData.Photos> imgUrlArr2){
        this.context = context;
        inflater = LayoutInflater.from(context);
        this.imgUrlArr2 = imgUrlArr2;
    }

    public MyInfoImgPagerAdapter(Context context, ArrayList<MyInfoData.Photos> imgUrlArr2){
        this.context = context;
        inflater = LayoutInflater.from(context);
        this.imgUrlArr2 = imgUrlArr2;
    }
