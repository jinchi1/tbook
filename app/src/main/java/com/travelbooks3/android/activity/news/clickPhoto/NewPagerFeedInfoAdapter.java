...
public class NewPagerFeedInfoAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<NewPagerData.MyPost.Photos> dataArr;

    public  NewPagerFeedInfoAdapter(Context context, ArrayList<NewPagerData.MyPost.Photos> arr){
        this.context = context;
        this.dataArr = arr;
    }

    public void addItems(ArrayList<NewPagerData.MyPost.Photos> addItem) {
        dataArr = addItem;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final NewPagerData.MyPost.Photos data = dataArr.get(position);
