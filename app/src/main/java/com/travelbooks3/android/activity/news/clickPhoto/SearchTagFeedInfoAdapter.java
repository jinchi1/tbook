...
public class SearchTagFeedInfoAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<SearchTagPostData.Photos> dataArr;

    public  SearchTagFeedInfoAdapter(Context context, ArrayList<SearchTagPostData.Photos> arr){
        this.context = context;
        this.dataArr = arr;
    }

    public void addItems(ArrayList<SearchTagPostData.Photos> addItem) {
        dataArr = addItem;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final SearchTagPostData.Photos data = dataArr.get(position);
