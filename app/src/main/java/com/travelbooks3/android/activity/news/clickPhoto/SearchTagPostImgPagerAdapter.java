...
public class SearchTagPostImgPagerAdapter extends PagerAdapter {
    private Context context;
    private LayoutInflater inflater;
    private ArrayList<SearchTagPostData.Photos> imgUrlArr2;


    public SearchTagPostImgPagerAdapter(ClickPhotoActivity context, ArrayList<SearchTagPostData.Photos> imgUrlArr2){
