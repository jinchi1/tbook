...
import com.travelbooks3.android.activity.news.NewPagerFragment;
...
public class TagAboutAdapter extends BaseAdapter {
    ...
    public  TagAboutAdapter(Context context, ArrayList<TagDefaultData> arr){
