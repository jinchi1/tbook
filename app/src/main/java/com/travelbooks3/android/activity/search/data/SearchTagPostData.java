...
public class SearchTagPostData {
    ...
    public static SearchTagPostData SearchTagPostJson(SearchTagPostData data, JSONObject json) throws Exception{
        if(data == null) data = new SearchTagPostData();
