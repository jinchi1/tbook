...
public class WritePhotoPagerNewAdapter extends PagerAdapter{
    ...
    public WritePhotoPagerNewAdapter(WriteTestActivity context, ArrayList<String> imgUrlArr){
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if(imgUrlArr.size()==1)
        {
            LogUtil.d(String.valueOf(imgUrlArr.size()));
